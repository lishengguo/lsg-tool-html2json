(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MakaApp-lsg-tool-html2json"] = factory(require("maka"), require("react"));
	else
		root["MakaApp-lsg-tool-html2json"] = factory(root["maka"], root["react"]);
...
(function () {
  ...
  this.HTMLtoJSON = function (html) {
    ...
    HTMLParser(html, {
      ...
      spar: '',
      paths: [0],
      moveLevel: function moveLevel(step) {
        this.level += step;
      ...
      comment: function comment(text) {//results += "<!--" + text + "-->";
      },
      parseStyle: function parseStyle(style) {
        ...
        style.replace(/([\w-]+)?:([^;]+)?/g, function (match, key, value) {
          if (key.indexOf('-') != -1) {
            key = _this.toCamp(key);
          }
      ...
      toCamp: function toCamp(key) {
        var ks = key.split('-');
        var camp = ks[0];
        ks.forEach(function (item, index) {
...
/* harmony import */ var _usr_local_lib_node_modules_makajs_cli_node_modules_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
/* harmony import */ var _package_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
var _package_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(4, 1);
/* harmony import */ var maka__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(0);
...
/* harmony import */ var react_codemirror2__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
...
/* harmony import */ var _style_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(11);
...
/* harmony import */ var codemirror_theme_material_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(12);
...
/* harmony import */ var codemirror_lib_codemirror_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(13);
...
/* harmony import */ var _htmlparser__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(2);
/* harmony import */ var _htmlparser__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_htmlparser__WEBPACK_IMPORTED_MODULE_8__);
...
var action = (_dec = Object(maka__WEBPACK_IMPORTED_MODULE_3__["actionMixin"])('base'), _dec(_class = function action(option) {
  ...
  _usr_local_lib_node_modules_makajs_cli_node_modules_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(this, "parseJson", function (data) {
    return function (e) {
      var str = _htmlparser__WEBPACK_IMPORTED_MODULE_8__["HTMLtoJSON"](data.html);
